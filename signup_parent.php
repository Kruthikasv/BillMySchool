...
<body>
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['submitpost'])) {
      $sql = "INSERT INTO patient (fname,lname,student,email,contact,address,password) VALUES('$_POST[fname]', '$_POST[lname]',
         '$_POST[dob]', '$_POST[email]', '$_POST[contact]', '$_POST[address]', '$_POST[password]')";
