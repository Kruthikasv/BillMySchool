      ...
      <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto ">
            <li class="nav-item">
              <a class="nav-link" href="#about" style="text-shadow: 1px 1px #c0c0c0;color:rgb(150, 79, 29); ">About</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#heading" style="text-shadow: 1px 1px #c0c0c0;color:rgb(150, 79, 29); ">Login/Sign-up </a>
            </li>
          </ul>
        </div>
      </nav>
